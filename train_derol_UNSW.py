...
from analyst_manager.UNSWAnalystManagement import UNSWAnalystManagement
from classifiers.UNSWClassifier import UNSWClassifier
...
def benchmark(argv):
    ...
    with tf.Session() as sess:
        ...
        generator = UNSWGenerator(data_folder=argv[0], batch_size=batch_size, classes=loaded_characters,
